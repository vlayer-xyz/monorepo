...
exports.deflattenPublicInputs = exports.flattenPublicInputsAsArray = exports.flattenPublicInputs = void 0;
...
exports.flattenPublicInputs = flattenPublicInputs;
...
function deflattenPublicInputs(flattenedPublicInputs, abi) {
    ...
    const public_parameter_witnesses = public_parameters.flatMap((param) => abi.param_witnesses[param.name].flatMap((witness_range) => Array.from({ length: witness_range.end - witness_range.start }, (_, i) => witness_range.start + i)));
