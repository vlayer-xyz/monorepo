...
// MAX_LEAF_SIZE_M = MAX_RLP_LIST_HEADER_SIZE + ((MAX_KEY_RLP_HEADER_SIZE + MAX_KEY_SIZE) + (MAX_RECEIPT_HEADER_SIZE_M + MAX_RECEIPT_SIZE_M))
...
export const MAX_RECEIPT_LEAF_SIZE_M = 1039;
