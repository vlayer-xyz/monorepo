...
import { ExtendedClient, NoirArguments } from './oracles.js';
...
export const getProofOracle = async (client: ExtendedClient, args: NoirArguments): Promise<ForeignCallOutput[]> => {
