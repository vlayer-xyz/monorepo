...
export const MAX_RECEIPT_TREE_DEPTH = 7;
...
export const MAX_TRANSACTION_RLP_LEN = MAX_TRIE_NODE_LEN;
export const MAX_TRANSACTION_PROOF_LEN = MAX_TRIE_NODE_LEN * MAX_TRANSACTION_TREE_DEPTH;
