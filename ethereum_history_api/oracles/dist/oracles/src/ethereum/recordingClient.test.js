...
import { createRecordingClient } from './recordingClient.js';
...
const BLOCK_HASH = '0xbe8aa5945d3377e65ed06757555d0d4babe269097574c210133e59cf6bc17d18';
const STORAGE_HASH = '0xae2792244417bc1749b9cd9a0bdc1c4a6cf32f147b37202c8cb3590777659aec';
export const GET_PROOF_PARAMETERS = {
    blockNumber: BLOCK_NUMBER,
    storageKeys: [],
    address: ADDRESS
};
export const GET_BLOCK_PARAMETERS = { blockNumber: BLOCK_NUMBER };
...
describe('recordingClient', async () => {
    ...
    it('record and mock', async () => {
        await withTempFile(async (tempFilePath) => {
            ...
            const mockingClient = await createMockClient(tempFilePath);
