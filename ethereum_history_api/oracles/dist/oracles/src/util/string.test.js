...
describe('incHexStr', () => {
    ...
    it('big', () => {
        expect(incHexStr('0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff1')).toEqual('0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff2');
    });
});
describe('incHexByte', () => {
    it('zero', () => {
