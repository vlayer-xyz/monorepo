...
import { getAccountOracle, getAccountProof } from '../../../src/noir/oracles/accountOracles.js';
...
describe(
  ...
  async () => {
    ...
    it('getAccountOracle', async () => {
      ...
      const account = await getAccountOracle(createDefaultClient(), [
        [blockNumberInNoirFormat],
        accountAddressInNoirFormat
      ]);
      // prettier-ignore
