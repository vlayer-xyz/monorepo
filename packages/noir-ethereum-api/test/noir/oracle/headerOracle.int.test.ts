...
describe('headerOracle', async() => {
  ...
  it('getHeaderOracle', async() => {
    ...
    expect(blockHeader[0]).toStrictEqual(['0xd7', '0xf8', '0x97', '0x4f', '0xb5', '0xac', '0x78', '0xd9',
      '0xac', '0x9', '0x9b', '0x9a', '0xd5', '0x1', '0x8b', '0xed', '0xc2', '0xce', '0xa', '0x72',
      '0xda', '0xd1', '0x82', '0x7a', '0x17', '0x9', '0xda', '0x30', '0x58', '0xf', '0x5', '0x44'
    ]);
  });
}, {
  timeout: 20000
